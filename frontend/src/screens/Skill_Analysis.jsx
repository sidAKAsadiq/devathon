  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/api/skill-gap/analyze/pdf",
        {
          method: "POST",
          body: formData,
        }
        ...
        >
          ...
          >
            {["name", "email", "careerGoal"].map((field) => (
              <TextField
                ...
                required    
                fullWidth
                disabled={field === "name" || field === "email"} // lock these
              />
            ))}
            <TextField
          ...
          >
            ...
            <Typography variant="body2" color="textSecondary">
              Resume data is used only for analysis. We do not share your
              personal info with anyone.
            </Typography>
          </Box>
